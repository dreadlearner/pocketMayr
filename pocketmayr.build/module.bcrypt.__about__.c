...
static PyCodeObject *codeobj_6225b2d3ee5e654954b4859a097774ae;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[28]); CHECK_OBJECT(module_filename_obj);
    codeobj_6225b2d3ee5e654954b4859a097774ae = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE | CO_FUTURE_UNICODE_LITERALS, mod_consts[29], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_6225b2d3ee5e654954b4859a097774ae;
    ...
    // Frame without reuse.
    frame_6225b2d3ee5e654954b4859a097774ae = MAKE_MODULE_FRAME(codeobj_6225b2d3ee5e654954b4859a097774ae, module_bcrypt$__about__);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_6225b2d3ee5e654954b4859a097774ae);
    assert(Py_REFCNT(frame_6225b2d3ee5e654954b4859a097774ae) == 2);
    ...
    }
    {
        ...
        frame_6225b2d3ee5e654954b4859a097774ae->m_frame.f_lineno = 16;
        {
    ...
    }
    {
        ...
        frame_6225b2d3ee5e654954b4859a097774ae->m_frame.f_lineno = 17;
        {
            PyObject *hard_module = IMPORT_HARD___FUTURE__();
    ...
    }
    {
        ...
        frame_6225b2d3ee5e654954b4859a097774ae->m_frame.f_lineno = 18;
        {
            PyObject *hard_module = IMPORT_HARD___FUTURE__();
    ...
    }
    {
        ...
        frame_6225b2d3ee5e654954b4859a097774ae->m_frame.f_lineno = 41;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_6225b2d3ee5e654954b4859a097774ae);
#endif
    popFrameStack();

    assertFrameObject(frame_6225b2d3ee5e654954b4859a097774ae);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_6225b2d3ee5e654954b4859a097774ae, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_6225b2d3ee5e654954b4859a097774ae->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_6225b2d3ee5e654954b4859a097774ae, exception_lineno);
    }
