...
static void createModuleCodeObjects(void) {
    ...
    codeobj_0b24524936f250ac9ce7022fa1b5452c = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[91], NULL, NULL, 0, 0, 0);
    codeobj_d78975e94258e61c721d9b66a02b9eba = MAKE_CODEOBJECT(module_filename_obj, 45, CO_NOFREE, mod_consts[83], mod_consts[92], NULL, 0, 0, 0);
    codeobj_1e1545f96b1ad00338f5e0741516560a = MAKE_CODEOBJECT(module_filename_obj, 78, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[88], mod_consts[93], NULL, 8, 0, 0);
    codeobj_c53d46b6a884a5ce398668437f965d98 = MAKE_CODEOBJECT(module_filename_obj, 75, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[85], mod_consts[94], NULL, 2, 0, 0);
    codeobj_29676688cdb90c5de700bbcc6a7f07e3 = MAKE_CODEOBJECT(module_filename_obj, 37, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[63], mod_consts[95], NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    branch_end_2:;
    {
        ...
        tmp_res = PyObject_SetItem(locals_numpy$_pytesttester$$$class__1_PytestTester_45, mod_consts[84], tmp_dictset_value);
        if (tmp_res != 0) {
            assert(ERROR_OCCURRED());
        ...
        }
        {
            ...
            tmp_res = PyObject_SetItem(locals_numpy$_pytesttester$$$class__1_PytestTester_45, mod_consts[88], tmp_dictset_value);
            Py_DECREF(tmp_dictset_value);
            if (tmp_res != 0) {
                assert(ERROR_OCCURRED());
        ...
        skip_nested_handling_1:;
        {
            ...
            tmp_tuple_element_1 = locals_numpy$_pytesttester$$$class__1_PytestTester_45;
        ...
        goto try_except_handler_1;
        outline_result_1:;
        UPDATE_STRING_DICT1(moduledict_numpy$_pytesttester, (Nuitka_StringObject *)mod_consts[83], tmp_assign_source_12);
    }
    goto try_end_1;
    // Exception handler code:
    try_except_handler_1:;
